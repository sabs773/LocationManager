...
<center>
  <a href ="LocationRegister.html" class = "btn btn-success">Add Location</a>
...
<tr> 
     <td><?php echo $i; ?></td> 
     <td class = ""><?php echo $row['LocationName']; ?></td>
     ...
     <td><a href ="EditLocation.php?token=<?php echo $row['LocationID'] ?>" class = "btn btn-primary">Edit</a></td>
     <td><a href ="DeleteLocation.php?token=<?php echo $row['LocationID'] ?>" class = "btn btn-danger">Delete</a></td>
